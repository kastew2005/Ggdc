...
import {CONFIG} from "./config.js";import {QualityManager} from "./QualityManager.js";import {World} from "./world/World.js?v=77.7";import {Player} from "./player/Player.js";import {Controls} from "./player/Controls.js";import {MobManager} from "./entities/Mob.js?v=77.7";import {MobSpawner} from "./entities/MobSpawner.js";import {Particles} from "./rendering/Particles.js";import {Lighting} from "./rendering/Lighting.js";import {Effects} from "./rendering/Effects.js";import {Weather} from "./rendering/Weather.js";import {AudioManager} from "./audio/AudioManager.js";import {Inventory} from "./inventory/Inventory.js";import {RECIPES_2X2,RECIPES_3X3} from "./inventory/Crafting.js?v=77.7";import {RECIPE_MANAGER} from "./inventory/RecipeManager.js?v=77.7";import {CraftingManager} from "./inventory/CraftingManager.js?v=77.7";import {CraftingTableUI} from "./inventory/CraftingTableUI.js?v=77.7";import {RecipeBookUI} from "./inventory/RecipeBookUI.js?v=77.7";import {HUD} from "./ui/HUD.js";import {Menu} from "./ui/Menu.js";import {SettingsManager} from "./ui/SettingsManager.js";import {SettingsUIController} from "./ui/SettingsUIController.js";import {MainMenuManager} from "./ui/MainMenuManager.js";import {SaveManager} from "./save/SaveManager.js";import {BLOCK,INFO,ITEM,ICON} from "./world/Block.js?v=77.7";import {Chunk} from "./world/Chunk.js";import {MiningSystem} from "./world/MiningSystem.js";import {SurvivalSystems} from "./systems/SurvivalSystems.js";import {NetworkManager} from "./network/NetworkManager.js";
import {WaterPhysics} from "./world/WaterPhysics.js";import {GIRendererController} from "./rendering/GIRendererController.js?v=77.7";import {VolumetricLightingManager} from "./rendering/VolumetricLightingManager.js?v=77.7";import {DebugConsole} from "./debug/DebugConsole.js";import {InventoryUI} from "./inventory/InventoryUI.js?v=77.7";
class Game{
 ...
 navigateToWorld(id){if(!id)return false;this.skipUnloadSave=true;try{localStorage.setItem("vs_pending_launch_v77_7",String(id))}catch{}try{sessionStorage.setItem("vs_pending_launch_v77_7",String(id))}catch{}try{const u=new URL(location.href);u.searchParams.set("launch",String(id));location.replace(u.href);return true}catch(e){console.error("WORLD NAVIGATION FAILED",e);try{location.reload()}catch{}return true}}
