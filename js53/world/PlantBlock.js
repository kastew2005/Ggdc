...
export class PlantBlock {
  static is(id){return !!(id && [BLOCK.GRASS_LOW,BLOCK.GRASS_HIGH_BOTTOM,BLOCK.GRASS_HIGH_TOP,BLOCK.FLOWER_POPPY,BLOCK.FLOWER_DANDELION,BLOCK.DEAD_BUSH,BLOCK.VINE,BLOCK.WHEAT,BLOCK.SEAGRASS,BLOCK.KELP].includes(id))}
